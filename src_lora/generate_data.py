...
def main(config: Config):
    ...
    """
    data.obs.shape = (4, 7936, 128, 679)
    data.action.shape = (4, 7936, 128, 6)
    data.done.shape = (4, 7936, 128)
    data.solved.shape = (4, 7936, 128)
    data.return_.shape = (4, 7936, 128)
    data.length.shape = (4, 7936, 128)
    """
